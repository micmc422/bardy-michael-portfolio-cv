...
export default async function BlogLayout({ children, params }: BlogLayoutProps) {
    ...
    return <Row fillWidth zIndex={0}>
        <Row maxWidth={12} m={{ display: "none" }} />
        <Row fillWidth horizontal="center">
            <Column maxWidth="xs" gap="l" paddingX="s">
                ...
                <Grid gap="8" columns={"2"} paddingTop="16" s={{ display: "flex", flexDirection: "column" }} >
        ...
        <Column maxWidth={12} paddingLeft="40" fitHeight position="sticky" top="80" gap="16" m={{ display: "none" }}>
            <Row
                gap="12"
                paddingLeft="2"
                vertical="center"
...
function SourcesComponent({ sources }: { sources: string[] }) {
    return (<Column>
        ...
        <Grid fillWidth columns="2" gap="16" className="mt-8" s={{ display: "flex", flexDirection: "column" }}>
