...
function ServicesInclus() {
    return servicesInclus.map(({ name, icon, desc, bgColor }, i) => <Column key={i} border="neutral-alpha-weak" radius="m" overflow="hidden">
        <Background
            fill
            position="absolute"
            zIndex={0}
        ...
        />
        <Column key={i} horizontal="start" padding="l" gap="s">
        <Row>
