...
export async function generateMetadata({
  ...
  return Meta.generate({
    ...
    baseURL: baseURL,
    image: project.metadata.image ? `${baseURL}/og?title=${project.metadata.title}${project.metadata.image}&/image=${project.metadata.title}` : `${baseURL}/og?title=${project.metadata.title}`,
