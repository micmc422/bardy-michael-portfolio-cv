...
export default async function About() {
  return (
    <>
      ...
      <Column maxWidth={"xl"} gap="m" paddingTop="xl" center>
        <Heading variant="display-strong-m">SEO Approfondi : Au-delà des Bases pour une Visibilité Maximale</Heading>
        <Text variant="body-default-l" onBackground="neutral-weak">Pour qu&apos;un site se distingue sur les moteurs de recherche et les réseaux sociaux, il faut aller au-delà du contenu visible. L&apos;optimisation des métadonnées, l&apos;intégration des Open Graph et l&apos;utilisation des JSON-LD sont cruciales pour une présence en ligne performante à Albi.</Text>
        <Row gap="l" tabletDirection="column">
          <Column gap="xs">
            <Heading as="h3" variant="display-default-xs">Meta Descriptions & Title Tags</Heading>
            <Text>Les métadonnées &quothistoriques&quot comme la balise {`<title>`} et la méta-description sont les premières informations que Google et les utilisateurs voient de votre page.</Text>
            <ul>
              <li>Bénéfice : Elles influencent directement le taux de clics (CTR) depuis les pages de résultats de recherche (SERP). Un titre accrocheur et une description pertinente incitent davantage les internautes à visiter votre site plutôt que celui d&apos;un concurrent à Albi.</li>
          ...
          <Column gap="xs">
            <Heading as="h3" variant="display-default-xs">Données Open Graph (OG)</Heading>
            ...
            <ul>
              <li>Bénéfice : Elles garantissent un affichage attrayant et cohérent de vos liens partagés, avec une image, un titre et une description choisis par vous. Cela augmente l&apos;engagement et la visibilité de votre entreprise d&apos;Albi sur les plateformes sociales.</li>
          ...
          <Column gap="xs">
            <Heading as="h3" variant="display-default-xs">Données Structurées (JSON-LD)</Heading>
            ...
            <ul>
              <li>Bénéfice : Elles améliorent la visibilité de votre site sur les SERP grâce à des étoiles d&apos;évaluation, des prix, des horaires ou d&apos;autres détails pertinents directement sous votre lien. Cela augmente considérablement votre CTR et votre crédibilité pour les recherches effectuées à Albi.</li>
